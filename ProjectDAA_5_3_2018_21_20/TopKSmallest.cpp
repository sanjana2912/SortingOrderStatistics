...
void TopKSmallest::print_and_write(float array[], int n)
{
    ...
    file2.open("C:\\Users\\kavya\\CLionProjects\\Menu\\output\\top_k_elements_"+timestamp+".txt");
...
void TopKSmallest::top_k_smallest_elements(float array[], int n, int k)
{
    int i;
    float temp_array[k];
    ...
    cout<<"\nElapsed time is :  "<< time/1000000 <<" ms "<<endl;
